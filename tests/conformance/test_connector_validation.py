...
class ConnectorCompanionTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for path in (self.checker.FEEDBACK_PATHS + self.checker.CONNECTOR_PATHS
                     ...
                     + self.checker.FRONTIER_TARGETS + self.checker.BOUNDARY_TARGETS
                     + self.checker.FINAL_TARGETS
                     + (self.checker.WORKFLOW_BASELINE, self.checker.FRONTIER_BASELINE, self.checker.BOUNDARY_BASELINE, self.checker.FINAL_BASELINE)):
    ...
    def test_complete_cli_proves_required_components_without_payload_growth(self):
        ...
        self.assertEqual([], self.checker.validate_workflow_parity(self.root))
