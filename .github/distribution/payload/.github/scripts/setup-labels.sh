...
create "exec:cloud"   "C2E0C6" "Route: available Codex cloud task — async, parallel, draft PR"
create "exec:app"     "BFDADC" "Route: available Codex app task — steerable, worktree-isolated"
create "exec:cli"     "FEF2C0" "Route: Codex CLI — scripted / batch / CI-triggered"
