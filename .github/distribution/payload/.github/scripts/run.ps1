...
#
# Prerequisite: Git for Windows (https://gitforwindows.org). The Codex
# workflow already requires Git, and this is the bash that ships with it.
...
if (-not $bash) {
    throw ('Git for Windows is required but bash.exe was not found ' +
        ...
        'https://gitforwindows.org and re-run. The Codex workflow ' +
