...
the source connector architecture (summarized below) — a
...
The source-template connector conformance script is not installed here.
Review these fields explicitly; installing these definitions does not enable
a push-time connector validation gate.
