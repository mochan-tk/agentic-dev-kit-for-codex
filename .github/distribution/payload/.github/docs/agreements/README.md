...
`.agents/skills/context-distillation/SKILL.md`; change control by
...
`.agents/skills/context-distillation/SKILL.md` ("When an agreement is
...
> not adopter decisions. The two-tier ADR-0003 ships separately as an
> explicitly historical protocol reference, not an accepted adopter ADR.
> This tree in your project holds *your* agreements only;
