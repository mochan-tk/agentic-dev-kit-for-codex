...
expect_rc 0 'unchanged local engine Bash syntax' bash -n "$ROOT/.github/scripts/scaffold-install.sh"
expect_rc_grep 0 'stage new files' 'help distinguishes external installation' bash "$SCRIPT" --help
t_summary
